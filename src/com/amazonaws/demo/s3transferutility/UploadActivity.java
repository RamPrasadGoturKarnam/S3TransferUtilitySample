...
public class UploadActivity extends ListActivity {
    ...
    private void initUI() {
        ...
        btnUploadFile = (Button) findViewById(R.id.buttonResume);
        ...
        btnClickPicture = (Button) findViewById(R.id.ClickPictureFromCamera);
        ...
        btnClickPicture.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent = new Intent(v.getContext(),PhotoIntentActivity.class);

                Log.i("Inside photoactivity","");
